...
public class TClasificador {
    ...
    public int[] clasificar(int[] datosParaClasificar, int metodoClasificacion) {
        switch (metodoClasificacion) {
            ...
            case METODO_CLASIFICACION_CUENTAS:
                return ordenarPorCuenta(datosParaClasificar,datosParaClasificar.length);
            default:
    ...
    private int encuentraPivote(int izq, int der, int[] arr) {
        if (arr[izq] > arr[der]) {
            return izq;
        } else {
            return der;
    ...
    private int[] ordenarPorCuenta(int[] datosParaClasificar, int maximo) {
