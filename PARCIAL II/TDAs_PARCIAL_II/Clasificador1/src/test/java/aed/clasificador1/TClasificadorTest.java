...
public class TClasificadorTest {
    ...
    public void testEstaOrdenadoFalso() {
        ...
        assertEquals(false, Clasificador1.estaOrdenado(vectorPrueba));
    }

    @Test
    public void testEstaOrdenadoVerdadero() {
        int[] vectorPrueba = {1, 10, 100, 486, 1000, 99999};
        assertEquals(true, Clasificador1.estaOrdenado(vectorPrueba));
    }
    ...
    @Test
    public void testOrdenarPorCuentas() {
        int[] vectorPrueba = {3, 2, 6, 4, 1};
        TClasificador clasificador = new TClasificador();
        int[] v = clasificador.clasificar(vectorPrueba, 6);
        int[] expectedArr = {1,2,3,4,6};
        assertArrayEquals(expectedArr, v);
    }
